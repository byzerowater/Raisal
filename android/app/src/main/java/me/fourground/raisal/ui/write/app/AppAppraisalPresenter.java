 ...
 */
public class AppAppraisalPresenter implements Presenter<AppAppraisalMvpView> {

    private final DataManager mDataManager;
    private AppAppraisalMvpView mMvpView;
    ...
    @Override
    public void attachView(AppAppraisalMvpView mvpView) {
        mMvpView = mvpView;
    }
